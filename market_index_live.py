...
LVL_MANIA, LVL_EUF, LVL_HBULL, LVL_EBULL, LVL_RECUP = 85, 70, 60, 50, 30
...
def main():
    ...
    result = {
        ...
        "levels": {"mania": LVL_MANIA, "euphoria": LVL_EUF, "healthy_bull": LVL_HBULL,
                   "early_bull": LVL_EBULL, "recovery": LVL_RECUP},
